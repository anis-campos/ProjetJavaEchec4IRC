...
public class Echiquier implements BoardGames {
    ...
    /**
     * @param message ne doit pas étre accessible de l'extérieur
     */
    ...
    public boolean isPlayerOk(Coord pieceCoord) {
        ...
        if (jeuCourant == jeuBlanc && getColorCurrentPlayer() == Couleur.BLANC) {
            return jeuBlanc.isPieceHere(pieceCoord.x, pieceCoord.y);
        } else if (jeuCourant == jeuNoir && getColorCurrentPlayer() == Couleur.NOIR)
            return jeuNoir.isPieceHere(pieceCoord.x, pieceCoord.y);
        return false;
    }
