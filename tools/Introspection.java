...
public class Introspection {
	 ...
	 * @param args - la liste des parametres de la methode
	...
	public static Object newInstance(String className) {
		...
		try	    {
			...
			// La classe est abstract ou est une interface ou n'a pas de constructeur accessible sans parametre
			e.printStackTrace();
		}
	...
	/**
	 * construction e partir du nom de la classe et des parametres du constructeur
	 * 
	 * @param className
